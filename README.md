...
기존의 유명한 이커머스 쇼핑몰중에는 대게 php, jsp등 레거시 코드로 개발된 경우가 많습니다. 
php 이커머스 오픈소스인 그누보드를 활용해서 결제 페이지에서 결제 경험의 성공률 증대를 위한 결제수단 프로모션 플러그인 스킬셋을 제작했습니다.
간단한 뱃지 기능을 통해 결제수단을 강조하고, 브랜드의 컬러 이미지에 맞는 설정으로 아이덴티티 역시 유지할 수 있습니다.
